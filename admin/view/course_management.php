    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form method="POST" action="">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
    <label class="block text-sm font-medium text-gray-700 mb-2">Course Outline (Har line ek point):</label>
    <textarea name="outline" rows="6" class="border border-gray-300 rounded-md px-3 py-2 w-full"></textarea>
</div>
