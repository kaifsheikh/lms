...
<div class="mb-6">
    <h1 class="text-2xl font-semibold text-slate-900">My Unassigned Students</h1>
</div>

<?php if (empty($students)): ?>
    <p class="text-slate-500">No unassigned students found.</p>
<?php else: ?>
            ...
            <tbody class="divide-y divide-slate-100">
                <?php foreach ($students as $student): ?>
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-slate-600"><?php echo htmlspecialchars($student['contact_number']); ?></td>
